...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row contentBody">
        ...
        <div class="col-6">
            ...
            <ContentTemplate>
                <asp:GridView ID="Gv_status" runat="server" CssClass="custom-gridview" AutoGenerateColumns="False" OnRowCommand="Gv_status_RowCommand" OnRowDataBound="Gv_status_RowDataBound">
                    <Columns>
